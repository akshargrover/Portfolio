    ...
    return (
        <nav className="w-serverList h-full bg-discord-serverRail flex flex-col items-center py-3 gap-2 flex-shrink-0">
            ...
            <div className="relative group w-12 h-12 flex items-center justify-center">
                {/* Hover Indicator Left Pill */}
                <div className="absolute -left-3.5 w-2 h-0 group-hover:h-5 bg-white rounded-r-lg transition-all duration-300"></div>
                {/* Icon block */}
                <div className="w-12 h-12 bg-[#36393f] group-hover:bg-discord-accent rounded-[24px] group-hover:rounded-[16px] flex items-center justify-center text-text-muted group-hover:text-white cursor-pointer transition-all duration-300">
            ...
            <div className="relative group w-12 h-12 flex items-center justify-center mt-1">
                ...
                {/* Icon block */}
                <div className="w-12 h-12 bg-discord-accent rounded-[16px] flex items-center justify-center text-white cursor-pointer transition-all duration-300 font-bold text-lg">
                    AG
                </div>
            </div>
