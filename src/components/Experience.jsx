    ...
    return (
        <div className="flex-1 h-full bg-discord-mainContent flex flex-col min-w-0">
            <div className="h-12 w-full flex items-center px-4 border-b border-[#292932] shadow-[0_1px_2px_rgba(0,0,0,0.1)] flex-shrink-0 z-10">
                ...
                <h2 className="text-[15px] font-bold text-text-main font-sans tracking-wide">experience</h2>
            </div>
            ...
            <div className="flex-1 overflow-y-auto px-4 pt-4 pb-8">
                <div className="max-w-3xl">
                    <div className="mt-8 mb-12">
                        ...
                        <h1 className="text-[32px] font-bold text-white mb-2">Welcome to #experience!</h1>
                        <p className="text-[15px] text-text-variant">Professional internships and roles I have held in the industry.</p>
                    </div>
                            ...
                            <div key={idx} className="flex -mx-4 px-4 hover:bg-[#2e3035]/40 py-2 transition-colors">
                                ...
                                <div className="w-full">
                                    <div className="flex items-end mb-1 leading-5">
                                        ...
                                        <span className="text-[12px] text-text-muted leading-4 font-medium">{job.duration}</span>
                                    </div>

                                    <h3 className="text-white font-bold text-[18px] mt-2 mb-1">{job.role} <span className="text-discord-accent text-[15px]">@ {job.company}</span></h3>
                                    <ul className="list-disc pl-5 mt-2 space-y-2 text-[15px] text-text-variant leading-relaxed">
